...
LOG_DIR="experiment/results/m4-coordination-statistical-logs"
...
echo
echo "Running randomized M4 Statistical benchmark..."
bash scripts/run_m4_coordination_statistical.sh

echo
echo "M4 Statistical session complete."
echo "Raw evidence:      experiment/results/m4-coordination-statistical-latest.json"
echo "Analysis:          experiment/results/m4-coordination-statistical-analysis-latest.json"
echo "Per-cycle evidence: experiment/results/m4-coordination-statistical-runs/"
